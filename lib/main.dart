...
class _HomePageState extends State<HomePage> {
  String dropdownvalue = 'Formas de pagamento';
  var items = [
    'Formas de pagamento',
    'Crédito',
    'Débito',
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width,
                              padding: EdgeInsets.only(bottom: 15, top: 15, left: 20),
                              child: Text('Informações do cliente', style: TextStyle( color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500),),
                            ),
                            SizedBox(height: 10,),
                          ],
                        )
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width,
                              padding: EdgeInsets.only(bottom: 15, top: 15, left: 20),
                              child: Text('Pagamento', style: TextStyle( color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500),),
                            ),
                            SizedBox(height: 10,),
                            Row(
                              children: [
                    ...
                    SizedBox(
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(12),
                            gradient: LinearGradient(colors: [Color(0xFFFA4100), Color(0xFFFA6900)])),
                        child: ElevatedButton(
                          onPressed: () {},
                          style: ElevatedButton.styleFrom(
                              primary: Colors.transparent),
                          child: Text('Confirmar Pagamento', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                        ),
                      ),
                    )
                  ],
